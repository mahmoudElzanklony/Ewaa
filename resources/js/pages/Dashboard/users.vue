            ...
            <div class="container mt-4 mb-4">
                ...
                <div class="overflow-auto">
                    <table class="myTable table text-center table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr v-for="(i,index) in vuex" :key="index" :class="'tr_'+i['id']">
                                <td><img :src="'/images/users/'+i['image']"></td>
                                <td>{{ i['username'] }}</td>
                                <td>{{ i['email'] }}</td>
                                <td>{{ i['phone'] }}</td>
                                <td>{{ i['country'][$page.props.lang+'_name'] }}</td>
                                <td>{{ i['address'] }}</td>
                                <td>{{ i['block'] == 1 ? switchWord('yes'):switchWord('no') }}</td>
                                <td>{{ i['auto_publish'] == 1 ? switchWord('yes'):switchWord('no') }}</td>
                                <td>
                                ...
                                <td class="actions">
                                    ...
                                    <span><i @click="delete_item('users',i['id'],'.tr_'+i['id'])" class="ri-close-line"></i></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
