...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    add_new_answer: function add_new_answer() {
      ...
      row.className = 'row';
      row.innerHTML = $(event.target).prev().find('.row:first-of-type')[0].innerHTML;
      $('.answers .inner .row').append();
      console.log($(event.target).prev().find('.row')[0]);
    }
  },
                    ...
                    [
                      ...
                      _c(
                        "div",
                        {
                          ...
                          staticClass: "new_questions mb-2",
                        },
                        [
                          _c("div", { staticClass: "form-group" }, [
                            _c("input", {
                          ...
                          _c("div", { staticClass: "form-group" }, [
                            _c(
                              ...
                              _vm._l(
                                Object.keys(_vm.question_data),
                                function (i, index) {
                                  return _c(
                                    "option",
                                    {
                                      key: index,
                                      domProps: { value: _vm.question_data[i] },
                                    },
                                    [
                                      _vm._v(
                                        "\n                                        " +
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                                    " +
                                        _vm._s(
                                          _vm.switchWord("add_question_answer")
                                        ) +
                                        "\n                                "
                                    ),
                                  ]
