...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixin: [_mixin_SwitchLangWord__WEBPACK_IMPORTED_MODULE_0__.default],
  data: function data() {
    return {};
  }
});
  ...
  data: function data() {
    return {
      words: {
        ...
        pending: 'معلق',
        prepared: 'تم التجهيز',
        sent_for_shipment: 'تم ارسالها عن طريق الشحن',
        trusted_seller: 'تاجر موثوق فيه',
        ...
        piece_info: 'بالقطعه',
        points: 'نقاط',
        select_your_color_and_size: 'من فضلك اختر اللون والمقاس المناسب لك',
        not_enough_stock_pieces: 'لا يوجد ما يكفي في المخزن لأتمام عمليه شرائك بنجاح',
        number_of_sizes_must_be_at_least_equal_pieces: 'لابد ان يكون عدد المقاسات المختاره علي الأقل مساوي لعدد القطع',
        please_select_support_type_first: 'من فضلك اختر نوع الدعم الفني اولا',
        please_wite_a_message_first: 'من فضلك اكتب رسالتك اولا',
        product_has_been_added_to_cart_successfully: 'تم اضافه المنتج الي سله المشتريات بنجاح',
        select_best_colors_of_product: 'من فضلك اختر افضل الألوان المناسبه للمنتج',
        select_best_sizes_of_product: 'من فضلك اختر افضل المقاسات المناسبه للمنتج',
        select_best_photos_of_product: 'من فضلك اختر افضل الصوره المناسبه للمنتج',
        there_are_some_sizes_are_empty: 'هناك بعد المقاسات تركتها فارغه يرجي ملئها كامل المقاسات الموجوده',
        please_check_from_your_serial: 'رقم التحقق غير صحيح',
        please_enter_your_phone_first: 'من فضلك ادخل رقم الهاتف اولا',
        make_sure_from_two_password_are_matched: 'تأكد من تطابق كلمتين المرور',
        you_can_add_discount_in_some_cases_for_example_if_you_have_min_five_pices_to_ten_pieces_you_will_have_discount: 'تستطيع اضافه حالات خاصه للتخفيضات علي سبيل المثال اذا اشتري زبون هذا المنتج عدد قطع من 5 الي 10 قطع يحصل علي تخفيض كذا .. انتبه ان هذا التخفيض لا يلغي التخفيض الاساسي المحدد بتاريخ اذا كان موجود',
        you_must_select_selling_by_piece_or_by_three: 'لابد ان تحدد طريقه البيع اما عن طريق الجمله او القطاعي او كلاهما',
        select_order_status: 'حالة الطلب',
        please_select_order_status: 'من فضلك اختر حاله الطلب',
        you_must_select_date_that_product_should_be_available: 'لابد من اختيار التاريخ الذي سيصبح فه المنتج متاحا'
      }
    };
  },
  methods: {
