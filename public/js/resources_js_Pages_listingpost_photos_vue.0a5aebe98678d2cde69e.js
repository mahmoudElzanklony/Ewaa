...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixin_SwitchLangWord__WEBPACK_IMPORTED_MODULE_2__.default, _mixin_delete_item__WEBPACK_IMPORTED_MODULE_3__.default],
  components: {
      ...
      if (this.files.length > 0 && this.files.length < 10 - this.number_of_photos) {
        for (var i = 0; i < this.files.length; i++) {
          ...
          if (parseFloat((Number(this.files[i].size) / 1024 / 1024).toFixed(2)) > 1) {
            ...
            var output = '<div class="image"><p><span>' + (Number(this.files[i].size) / 1024 / 1024).toFixed(2) + 'Mb</span><span style="display: none" ><i  number="' + i + '" class="ri-close-line delete-file-uploaded"></i></span></p>';
          ...
          "form",
          {
            ...
            on: {
              submit: function ($event) {
                ...
                return _vm.save_image.apply(null, arguments)
              },
            },
          },
          [
