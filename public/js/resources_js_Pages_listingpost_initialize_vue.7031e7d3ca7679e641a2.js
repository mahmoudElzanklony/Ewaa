...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    this.inialize_items_map({
      name: 'governments',
      value: this.data['governments']
    }); // check if listing_info is not null

    if (this.data['listing_info'] != null) {
      // get sub categories
      this.get_sub(this.data['listing_info']['category']['parent_id']); // get cities
          ...
          "form",
          {
            ...
            on: {
              submit: function ($event) {
                ...
                return _vm.save_inilaize_listing.apply(null, arguments)
              },
            },
          },
          [
            _vm.data["listing_info"] != null &&
            _vm.data["listing_info"].hasOwnProperty("id")
              ? _c("input", {
                  attrs: { type: "hidden", name: "id" },
                  domProps: { value: _vm.data["listing_info"]["id"] },
                })
              : _vm._e(),
            _vm._v(" "),
            _c("div", { staticClass: "row" }, [
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm._l(_vm.data["categories"], function (cat, index) {
                        return _c(
                          "option",
                          {
                            key: index,
                            domProps: {
                              ...
                              selected:
                                _vm.data["listing_info"] != null &&
                                _vm.data["listing_info"]["category"][
                                  "parent_id"
                                ] == cat["id"],
                            },
                          },
              ...
              _c("div", { staticClass: "col-sm-4" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("label", [_vm._v(_vm._s(_vm.keywords.sub_category))]),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                    ...
                    [
                      _c("option", { attrs: { value: "" } }, [
                        _vm._v(_vm._s(_vm.keywords.choose_sub_category)),
                      ]),
                      _vm._v(" "),
                      _vm._l(_vm.get_sub_data, function (c, index) {
                        return _c(
                          "option",
                          {
                            key: index,
                            domProps: {
                              ...
                              selected:
                                _vm.data["listing_info"] != null &&
                                _vm.data["listing_info"]["category_id"] ==
                                  c["id"],
                            },
                          },
                          [
              ...
              _c("div", { staticClass: "col-sm-4" }, [
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c(
                    ...
                    {
                      staticClass: "form-control",
                      attrs: { name: "rent_or_sale", required: "" },
                    },
                    [
                      _c(
                        "option",
                        {
                          ...
                          domProps: {
                            selected:
                              _vm.data["listing_info"] != null &&
                              _vm.data["listing_info"]["rent_or_sale"] ==
                                "sale",
                          },
                        },
              ...
              _c("div", { staticClass: "col-12" }, [
                _c(
                  ...
                  { staticClass: "row" },
                  _vm._l(
                    Object.keys(_vm.data["place_data"]),
                    function (i, index) {
                      return _c(
                        "div",
                        { key: index, staticClass: "col-lg-4 col-6" },
                        [
                          _c("div", { staticClass: "form-group" }, [
                            _c(
                              "select",
                              ...
                              [
                                _c("option", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.switchWord(_vm.data["place_data"][i])
                                    )
                                  ),
                                ]),
                                _vm._v(" "),
                                _vm._l(_vm.map_data(i), function (val, index) {
                                  return _c(
                                    "option",
                                    {
                                      key: index,
