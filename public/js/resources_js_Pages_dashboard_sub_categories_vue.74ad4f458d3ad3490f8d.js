...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    add_another_question: function add_another_question() {
      ...
      var _iterator = _createForOfIteratorHelper($('.old_questions div select option')),
          _step;
      ...
      var select = '<div class="form-group"><select name="questions[]" class="form-control" required>' + output + '</select><span class="delete-icon-input"><i class="ri-close-line"></i></span></div>';
