...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    add_another_question: function add_another_question() {
      var output = '<option>' + this.switchWord('select_question') + '</option>';

      var _iterator = _createForOfIteratorHelper($('old_questions div select options')),
          _step;
      ...
      var select = '<div class="form-group"><select class="form-control" required>' + output + '</select></div>';
      console.log(input);
      var div = document.createElement('div');
      div.className = 'form-group';
      div.append(input);
      div.append('<span class="delete-icon"><i class="ri-line-close"></i></span>');
      console.log(div);
      $(event.target).prev().append(div);
    }
  },
                ...
                _c("div", { staticClass: "modal-body" }, [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.question_selection == "old"
                        ? _c("div", { staticClass: "old_questions mb-2" }, [
