...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "h2 span[data-v-a857707c]:first-of-type {\n  color: #26a69a;\n  margin-left: 6px;\n  position: relative;\n  top: 2px;\n}", ""]);
// Exports
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("navbar-component"),
      _vm._v(" "),
      _c("div", { attrs: { className: "container mt-4 mb-6" } }, [
        _c("h2", { attrs: { className: "d-flex align-items-center mb-4" } }, [
          _vm._m(0),
          _vm._v(" "),
          _c("span", [_vm._v(_vm._s(_vm.keywords.list_property))])
        ]),
        _vm._v(" "),
        _c("div", { attrs: { className: "progress-form" } }, [
          _vm._m(1),
          _vm._v(" "),
        ...
        _c("form", [
          _c("div", { attrs: { className: "row" } }, [
            _c("div", { attrs: { className: "col-sm-6" } }, [
            ...
            _vm._v(" "),
            _c("div", { attrs: { className: "col-12" } }, [
              _c("div", { attrs: { className: "row" } }, [
                _c(
                  "div",
                  { attrs: { className: "col-lg-3 col-md-4 col-sm-6 col-12" } },
                  [
                    _c("div", { attrs: { className: "form-group" } }, [
          ...
          _vm._v(" "),
          _c("div", { attrs: { className: "text-center" } }, [
            _c("input", {
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("span", [
      _c("i", { attrs: { className: "ri-arrow-left-s-fill" } })
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { attrs: { className: "active" } }, [
      _c("i", { attrs: { className: "ri-check-line" } })
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", [_c("i", { attrs: { className: "ri-check-line" } })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
