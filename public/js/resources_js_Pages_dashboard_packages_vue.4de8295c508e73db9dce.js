...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    add_area_inputs: function add_area_inputs() {
      ...
      for (var _i = 0, _arr = ['country', 'government', 'city', 'area']; _i < _arr.length; _i++) {
        var item = _arr[_i];
