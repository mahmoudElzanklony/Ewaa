  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapMutations)({
    ...
    update_item: function update_item(e) {
      ...
      if (e != null) {
        ...
        var index = $('.point_ad form select').eq(0).find('option[value="' + e['type'] + '"]').index();
        var counter = 0;
  ...
  return _c(
    ...
    [
                ...
                _c(
                  ...
                  _vm._l(_vm.vuex_data, function (i, index) {
                    return _c("tr", { key: index, class: "tr_" + i["id"] }, [
                      _c("td", [_vm._v(_vm._s(i["place"]["ar_name"]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(i["place"]["en_name"]))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(_vm.switchWord(i["type"])))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(i["no_points"]))]),
                      _vm._v(" "),
      ...
      _c(
        "div",
        {
          staticClass: "modal fade point_ad",
          attrs: {
            id: "update_box",
            tabindex: "-1",
            role: "dialog",
                            ...
                            [
                              ...
                              input == "type"
                                ...
                                : _c("input", {
                                    ...
                                    domProps: { value: _vm.point_ad },
                                    on: {
                                      input: function ($event) {
                                        if ($event.target.composing) {
                                          return
                                        }
                                        _vm.point_ad = $event.target.value
                                      },
                                    },
                                  }),
                            ]
