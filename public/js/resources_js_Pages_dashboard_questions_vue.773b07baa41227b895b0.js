...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "questions",
  mixins: [_mixin_tableData__WEBPACK_IMPORTED_MODULE_1__.default, _mixin_SwitchLangWord__WEBPACK_IMPORTED_MODULE_2__.default, _mixin_delete_item__WEBPACK_IMPORTED_MODULE_3__.default, _mixin_UpdateStatus__WEBPACK_IMPORTED_MODULE_4__.default, _mixin_update_item__WEBPACK_IMPORTED_MODULE_6__.default],
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapMutations)({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "UpdateStatus",
  methods: {
    updateStatus: function updateStatus(id, table) {
          ...
          _c("div", { staticClass: "overflow-auto" }, [
            _c(
              ...
              [
                ...
                _c(
                  "tbody",
                  _vm._l(_vm.get_data, function (question, index) {
                    return _c(
                      "tr",
                      { key: index, class: "tr_" + question["id"] },
                      [
                        _c("td", [
                          question["icon"] != ""
                            ? _c("img", {
                                attrs: {
                                  src: "/images/icons/" + question["icon"],
                                },
                              })
                            : _c("img", {
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(question["ar_name"]))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(question["en_name"]))]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              _vm.switchWord(
                                "question_type_" + question["type"]
                              )
                            )
                          ),
                        ]),
                        ...
                        _vm._v(" "),
                        question["type"] == "select" &&
                        question["answers"][0]["tu_name"] != null
                          ? _c(
                              "td",
                        ...
                        _c("td", { staticClass: "actions" }, [
                          _c("span", [
                            _c("i", {
                              ...
                              on: {
                                click: function ($event) {
                                  return _vm.update_item(question)
                                },
                              },
                            }),
                          ]),
