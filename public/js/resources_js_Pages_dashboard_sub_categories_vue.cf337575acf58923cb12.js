...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    add_another_question: function add_another_question() {
      var input = event.target.previousElementSibling.children[0].children[0];
      var output = document.createElement('div');
      output.className = 'form-group';
      output.innerHTML = input + '<span class="delete-icon"><i class="ri-line-close"></i></span>';
      event.target.previousElementSibling.append(output);
    }
  },
