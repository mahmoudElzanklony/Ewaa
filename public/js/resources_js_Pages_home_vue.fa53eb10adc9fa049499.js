  ...
  data: function data() {
    return {
      words: {
        ...
        Know: 'أعرف',
        List: 'أعلن',
        Arabic_Language: 'اللغه العربية',
        English_Language: 'اللغة الأنجليزية'
      }
    };
  },
  methods: {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".nav-link .box[data-v-485090b2] {\n  position: absolute;\n  top: 0px;\n  display: none;\n}\n.nav-link p[data-v-485090b2] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.nav-link p span[data-v-485090b2]:nth-of-type(2) {\n  margin-right: 7px;\n  margin-left: 7px;\n}\n#navbarDropdown[data-v-485090b2]::after {\n  display: none;\n}", ""]);
// Exports
            ...
            _c("ul", { staticClass: "navbar-nav" }, [
              _c("li", { staticClass: "nav-item" }, [
                _c("div", { staticClass: "nav-link" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "box" }, [_vm._v("ABC")])
                ])
              ]),
              _vm._v(" "),
              _c("li", { staticClass: "nav-item" }, [
