      ...
      if (this.files.length > 0 && this.files.length < 10 - this.number_of_photos) {
        for (var i = 0; i < this.files.length; i++) {
          ...
          if (parseFloat((Number(this.files[i].size) / 1024 / 1024).toFixed(2)) > 1) {
            ...
            var output = '<div class="image"><p><span>' + (Number(this.files[i].size) / 1024 / 1024).toFixed(2) + 'Mb</span><span ><i class="delete-file-uploaded" number="' + i + '" class="ri-close-line"></i></span></p>';
